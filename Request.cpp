...
/*   Updated: 2024/03/25 10:57:12 by apayen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Request::Request(Client *cl, Request *rhs) : _client(cl), _serv(rhs->_serv), _inparse(rhs->_inparse), \
	...
	_request(rhs->_request), _header(rhs->_header), _body(rhs->_body), _bodyresponse(rhs->_bodyresponse), \
	_response(rhs->_response), _status(rhs->_status), _name(rhs->_name), _method(rhs->_method), \
	_filename(rhs->_filename), _filepath(rhs->_filepath), _fdfile(rhs->_fdfile), _stat(rhs->_stat), \
	_contentlength(rhs->_contentlength), _maxcontentlength(rhs->_maxcontentlength), _multi(rhs->_multi), \
	_boundary(rhs->_boundary), _files(rhs->_files), _postsuccess(rhs->_postsuccess), _iscgi(rhs->_iscgi), \
	_cgi(rhs->_cgi), _cookie(rhs->_cookie), _get(rhs->_get), _post(rhs->_post), _del(rhs->_del), _dir(rhs->_dir), \
